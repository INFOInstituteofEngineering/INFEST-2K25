...
const MenuItems = ({ setShowMenu }) => {
    return (
        <div className="fixed w-[25%] sm:w-[90%] md:w-[50%] duration-500 bg-gradient-to-r from-blue-500 to-cyan-500 backdrop-blur-lg bg-opacity-80 top-[25%] sm:top-[11%] right-0 py-[2.5%] pt-[2%] h-[100vh] z-50 shadow-2xl rounded-l-3xl border-l-[3px] border-white">
            ...
            <div className='flex flex-col gap-10 p-5 justify-center rounded-md pl-[25%] text-[18px] w-full text-white h-full'>
                <Link to={"/"} 
                    className='font-medium cursor-pointer relative before:absolute before:-bottom-1 before:left-0 before:w-0 before:h-[2px] before:bg-white before:transition-all before:duration-200 hover:before:w-full'>
                    Home
                </Link>
                <Link to={"/event/tech"} 
