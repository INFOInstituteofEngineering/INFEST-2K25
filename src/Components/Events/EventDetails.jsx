...
=======
const EventDetailsComponent = ({ title, desc, img, rules, criteria, mobile, stdmobile, coordinator, studentCoordinator, email }) => {
>>>>>>> 787d2d09fc881784cff4df830b0b8913291280cf
...
=======
      ...
      <div className="flex flex-row items-center border gap-[5%] px-[4%] py-[2%] w-[90%] bg-gray-100 my-[2%] mt-[3%] mx-auto justify-between">
     ...
     <div className="flex flex-row gap-1 items-start font-bold text-[20px]">
      ...
      <div className="flex flex-col w-full text-center font-bold text-[20px] ml-2 ">
        <h1>Email :</h1>
        <h1>{email}</h1>
      </div>
    </div>
