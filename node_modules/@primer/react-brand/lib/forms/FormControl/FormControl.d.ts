 ...
 */
export declare const FormControl: (({ children, className, hasBorder, fullWidth, id, required, size, validationStatus, ...rest }: PropsWithChildren<FormControlProps>) => JSX.Element) & {
    Label: ({ children, className, htmlFor, required, showRequiredIndicator, size, validationStatus, visuallyHidden, ...rest }: PropsWithChildren<FormControlLabelProps>) => JSX.Element;
    Validation: ({ children, validationStatus }: FormControlValidationProps) => JSX.Element;
    Hint: ({ children, className, ...rest }: FormControlHintProps) => JSX.Element;
};
export {};
