 ...
 */
export declare const Timeline: (({ animate, className, children, fullWidth, ...rest }: PropsWithChildren<TimelineProps>) => JSX.Element) & {
    Item: ({ className, children, ...rest }: PropsWithChildren<TimelineItemProps>) => JSX.Element;
};
