...
function atcb_decorate_data_options(data) {
  ...
  for (let i = 0; i < theOptions.length; i++) {
    ...
    if (atcbIsiOS() && atcbiOSInvalidOptions.includes(optionName) || data.recurrence && data.recurrence !== "" && (!atcbValidRecurrOptions.includes(optionName) || data.recurrence_until && data.recurrence_until !== "" && (optionName === "apple" || optionName === "ical") || atcbIsiOS() && optionName === "google") || data.subscribe && atcbInvalidSubscribeOptions.includes(optionName)) {
      continue;
    }
    ...
    async initializeComponent() {
      ...
      if (this.hasAttribute("proKey") && this.getAttribute("proKey") !== "" || this.hasAttribute("prokey") && this.getAttribute("prokey") !== "") {
        ...
        if (this.hasAttribute("proKey") && this.getAttribute("proKey") !== "") {
          this.data = await atcb_get_pro_data(this.getAttribute("proKey"), this, { dev });
        } else {
          this.data = await atcb_get_pro_data(this.getAttribute("prokey"), this, { dev });
        }
...
add-to-calendar-button/dist/module/index.js:
   ...
   *)
*/
//# sourceMappingURL=add-to-calendar-button.js.map
